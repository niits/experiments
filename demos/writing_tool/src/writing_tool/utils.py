"""Utility functions for the writing tool package.

This module contains legacy utility functions that are maintained for backward compatibility.
For new development, prefer using the service classes in the services module.

DEPRECATED: Most functions in this module are deprecated in favor of the new service-based architecture.
Please use the services in writing_tool.services instead.
"""
