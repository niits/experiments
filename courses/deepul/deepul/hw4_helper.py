...
from .utils import get_data_dir, save_training_plot, savefig, show_samples
...
def q1_save_results(fn):
    ...
    save_training_plot(
        train_losses, test_losses, f"Q1 Train Plot", f"results/q1_train_plot.png"
    )
...
def q2_save_results(fn):
    ...
    print(f"Final Test Loss: {test_losses[-1]:.4f}")
    save_training_plot(
        train_losses, test_losses, "Q2 Train Plot", "results/q2_train_plot.png"
    )
    ...
    show_samples(
        ...
        title=f"Q2 CIFAR-10 generated samples",
    )
...
def q3a_save_results(fn):
    ...
    show_samples(
        recons * 255.0,
        fname="results/q3_a_reconstructions.png",
        title=f"Q3(a) CIFAR-10 VAE Reconstructions",
    )
